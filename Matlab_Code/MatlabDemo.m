...
%directoryPath = 'D:\Experiments\Github_library\data_NETCDF'; 
...
prompt = {'Enter a number 1 to 2048:'};
...
%put RGB image and labeled image sidy by side on the top and spectrum on
%the bottom
I1=ncread(NetcdfFileList(k).name,'RgbImage');
I2=ncread(NetcdfFileList(k).name,'LableledImage');
figure
